module Worthwhile::CatalogController
  ...
  included do
    ...
    configure_blacklight do |config|
      ...
      config.add_facet_field solr_name('creator', :facetable), limit: 5, sort: 'index'
      config.add_facet_field solr_name("tag", :facetable), limit: 5, sort: 'index'
      config.add_facet_field "subject_sort", label:'Subject', limit: 5, sort: 'index', helper_method: :find_case
      config.add_facet_field solr_name("language", :facetable), limit: 5, sort: 'count'
      config.add_facet_field solr_name("based_near", :facetable), limit: 5, sort: 'index'
      ...
      config.add_index_field solr_name("creator", :stored_searchable), separator: '; '
      # config.add_index_field solr_name("contributor", :stored_searchable), separator: '; '
  ...
  module ClassMethods 
    ...
    def search_config
      {
        'qf' => ['title_tesim','desc_metadata__name_tesim', 'id', 'desc_metadata__creator_tesim', 'desc_metadata__description_tesim'],
        'qt' => 'search',
        'rows' => 10
      }
    end
